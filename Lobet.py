...
| $$      | $$  | $$| $$\  $$$   | $$   | $$      
| $$$$$$$$|  $$$$$$/| $$ \  $$   | $$   | $$$$$$$$
|________/ \______/ |__/  \__/   |__/   |________/                                                                                                                                                                                                                                                                                               
{warna}---------------------------------------------------{P}
 Author    {M}:\033[1;37m LUTHFI XD
 Github    {M}:\033[1;37m LuthfiXayoranaXD
 Facebook  {M}:\033[1;37m LUTHFI XONTOL
 Tool Name {M}:\033[1;37m LUTHFI-GREEN
...
def Subscraption():
    ...
    if key1 in r1:
        ...
        time.sleep(2)
        os.system("clear")
        banner2();print(f"\033[1;37m[\033[1;31m✓\033[1;37m] {RED}{BA}Hi Dear User  Your Key is Not Approved{N}");print (f"\033[1;37m[\033[1;31m✓\033[1;37m]\033[1;34m Key {P}= {warna}"+key1);print(led);print(f"\033[1;37m[\033[1;32m•\033[1;37m] Tools {M}: {H}FACEBOOK CLONING {N}");print(f"\033[1;37m[\033[1;32m•\033[1;37m] Note {M} :{K} {BA}FREE USER INBOX KONTOL {N}");print(led);print(f'{H}{BA}MAKANYA GANTENG{N}');print(led);print(f'{P}[{M}•{P}] BUAT FILE DISINI{N} ');print(f'{P}[{M}•{P}] FILE CLONING{N} ');print(f'{P}[{M}•{P}] GMAIL CLONING{N} ');print(f'{P}[{M}•{P}] NOMOR CLONING{N} ');print(f'{P}[{M}•{P}] LUTHFI XD CLONING {N} ');print(f'{P}[{M}•{P}] RANDOM ID CLONING {N} ');print(led);print(f'{N}{BA}BUY CLONING/NOMOR CLONING{N}');print(led);print(f'{P}[{H}1{P}] {H}BUY GREEN CLONING{N} ');print(f'{P}[{B}2{P}] {B}KONTAK GREEN ADMIN{N} ');print(f'{P}[{K}3{P}] {K}FOLLOW GITHUB LUTHFI{N} ');print(f'{P}[{RED}4{P}] {RED}EXIT GREEN ');print(led)
        opt = input(f'{P}[{M}+{P}] Choose {M}:{H} ')
        if opt =='1':
            tks = '*ASALAMUALIKUM*%2C%20*LUTHFI XD*%20*I*%20*SAYA*%20*TO*%20*BUY*%20*YOUR*%20*NEW*%20*---*%20*LUTHFI_GREEN%20*---*%20*Version%20:%201.0.2%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20*My*%20*Key*%20*='+key1
            os.system('xdg-open  https://wa.me/+6283861351898?text='+tks)
            Subscraption()
        if opt =='2':
            os.system('xdg-open https://www.facebook.com/sipalinggantengEXE');Subscraption()
        if opt =='3':
            os.system('xdg-open https://www.facebook.com/sipalinggantengEXE');Subscraption()
        if opt =='4':
...
def Subscraption1():
    ...
    if key2 in r1:
        ...
        opt = input(f'{P}[{M}+{P}] Choose {M}:{H} ')
        if opt =='1':
            tks = '*ASALAMUALIKUM*%2C%20*LUTHFI XD*%20*I*%20*SAYA*%20*TO*%20*BUY*%20*YOUR*%20*NEW*%20*---*%20*MR_CRAZY_COMMAND%20*---*%20*Version%20:%201.0.2%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20*My*%20*Key*%20*='+key1
            os.system('xdg-open  https://wa.me/+6283861251898?text='+tks)
            Subscraption()
        if opt =='2':
            os.system('xdg-open https://www.facebook.com/sipalinggantengEXE');Subscraption()
        if opt =='3':
...
def menu():
            ...
            if crazy_nil in ['1','01']:
                ...
                os.system('xdg-open https://www.facebook.com/sipalinggantengEXE?mibextid=ZbWKwL');menu()
